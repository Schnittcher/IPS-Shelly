# ShellyPro4PM
   Dieses Modul ermöglicht es, ein Shelly Pro 4PM in IP-Symcon zu integrieren.\
   ...
   Feld | Beschreibung
   ------------ | ----------------
   MQTT Topic | Hier wird das Topic (shelly4pro-deviceid) des Shelly Pro 4PM eingetragen.
