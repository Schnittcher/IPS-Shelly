...
class Gen3Shelly1Mini extends ShellyModule
{
    public static $Variables = [
        ['State', 'State', VARIABLETYPE_BOOLEAN, '~Switch', ['gen3shelly1mini', 'gen3shelly1pmmini'], '', true, true],
        ['Power', 'Power', VARIABLETYPE_FLOAT, '~Watt.3680', ['gen3shelly1pmmini', 'gen3shellypmmini'], '', false, true],
        ['TotalEnergy', 'Total Energy', VARIABLETYPE_FLOAT, '~Electricity', ['gen3shelly1pmmini', 'gen3shellypmmini'], '', false, true],
        ['Current', 'Current', VARIABLETYPE_FLOAT, '~Ampere', ['gen3shelly1pmmini', 'gen3shellypmmini'], '', false, true],
        ['Voltage', 'Voltage', VARIABLETYPE_FLOAT, '~Volt', ['gen3shelly1pmmini', 'gen3shellypmmini'], '', false, true],
